...
app.use("/:website/:query/:page?", (req, res, next) => {
  ...
  if (website === "yts") {
    scrapYts.yts(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "eztv") {
    scrapEzTVio.ezTV(query).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "torlock") {
    scrapTorLock.torLock(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "tgx") {
    torrentGalaxy(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "zooqle") {
    zooqle.zooqle(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "bitsearch") {
    bitSearch(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "magnetdl") {
    magnet_dl(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "limetorrent") {
    limeTorrent(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "torrentfunk") {
    torrentFunk(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "torrentproject") {
    torrentProject(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
  ...
  if (website === "nyaasi") {
    if (page > 14) {
      ...
      scrapNyaa.nyaaSI(query, page).then((data) => {
        if (data === null) {
          return res.json({
            error: "Website is blocked change IP",
          });
  ...
  if (website === "ettv") {
    ettvCentral(query, page).then((data) => {
      if (data === null) {
        return res.json({
          error: "Website is blocked change IP",
        });
